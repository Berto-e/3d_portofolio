  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Alberto Álvarez González",
          from_email: form.email,
          to_email: "airsoftbusinc@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Gracias. Te responderé tan rápido como pueda.");
        ...
        (error) => {
          ...
          alert("Ahh, algo fue mal. Porfavor intentalo de nuevo.");
        }
      );
  };
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder='¿Qué quieres comentarme?'
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
